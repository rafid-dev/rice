...
template <Color c>
Score EvaluatePawnPsqt(Board &board)
{
  Score score;
  Square sq;
...
template <Color c>
Score EvaluateRooks(Board &board, U64 all, int &gamePhase)
{
  Score score;
  Square sq;
...
template <Color c>
Score EvaluateQueens(Board &board, U64 all, int &gamePhase)
{
  Score score;
  Square sq;
...
template <Color c>
Score EvaluateKings(Board &board)
{
  Score score;
  Square sq;
